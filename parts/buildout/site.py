...
def addsitepackages(known_paths):
    ...
    setuptools_path = '/Users/patrick/.buildout/eggs/setuptools-0.6c12dev_r88846-py2.6.egg'
    sys.path.append(setuptools_path)
    known_paths.add(os.path.normcase(setuptools_path))
    import pkg_resources
    buildout_paths = [
        '/Users/patrick/.buildout/eggs/setuptools-0.6c12dev_r88846-py2.6.egg',
        '/Users/patrick/.buildout/eggs/zc.buildout-1.5.2-py2.6.egg'
        ]
    ...
    original_paths = [
        '/Users/patrick/opt/lib/python2.6/site-packages'
        ]
